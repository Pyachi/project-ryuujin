...
/**
 * Non-LevelObject object that the Navigator can move on
 */
public class NavPath extends GameObject {
    private boolean measured;
    
    /**
     * Creates a NavPath at the given location
     *
     * @param loc the location of the NavPath
     */
    ...
    /**
     * When spawned in, checks the surrounding tiles and adjusts the texture accordingly
     */
    @Tick
