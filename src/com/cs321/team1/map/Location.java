...
public record Location(int x, int y) {
    ...
    public static Location fromString(String loc) {
        var args = loc.split(":");
        if (args[0].equals("T")) return Location.Tile(Integer.parseInt(args[1]), Integer.parseInt(args[2]));
        else return new Location(Integer.parseInt(args[1]), Integer.parseInt(args[2]));
    }
}
